...
class AnimationCounter extends React.Component {
  ...
  animate() {
    const { effect, frameLength } = this.props;
    const style0 = {
    ...
    const waitOrFinish = () => {
      ...
      const frame = Math.floor((lastTime - startTime) / (1000.0 / 60.0) % frameLength)
